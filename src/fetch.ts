...
export async function httpGet(url: string, params?: Record<string, string | number>): Promise<Response> {
...
export async function getText(url: string, params?: Record<string, string | number>): Promise<string> {
